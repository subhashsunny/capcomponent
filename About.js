  ...
  <div class="pt-16 mb-16 lg:mb-0 lg:pt-32 lg:max-w-lg lg:pr-5">
    <div class="max-w-xl mb-6">
      ...
      <p class="text-base text-gray-700 md:text-lg">
        Infinite wallet app for payments is the most secured and user friendly,with easy payments to friends,family and for buisiness purposes.This Wallet app is also used to make fixed deposit,credit card and debit card uses,gold to buy with rates and also to pay electric bills and other daily circling bill.
      </p>
    </div>
  </div>
  <div>
